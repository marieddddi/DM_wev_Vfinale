...
switch ($view) {
	...
	//si on veut afficher la page mon_compte, on vérifie que l'utilisateur est connecté. S'il ne l'est pas, on affiche la page d'accueil
	case "mon_compte":
		if (valider("connecte", "SESSION"))
			include("templates/mon_compte.php");
		else
			include("templates/accueil.php");
		break;
